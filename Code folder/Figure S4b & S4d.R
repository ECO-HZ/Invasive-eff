...
ggplot()+
  ...
  labs(x = NULL, 
       ...
       tag = "b", title = c("Among co-occurring native species")) -> Figure_S4b; Figure_S4b
...
ggplot()+
  ...
  labs(x = "Mean pair-wise Bray–Curtis\ndissimilarities estimated in the greenhouse experiment", 
       y = "", title = c("Among co-occurring alien species"), tag = "d") -> Figure_S4d; Figure_S4d

# 
Figure_S4b/Figure_S4d
