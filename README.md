...
The results supporting the community assembly analyses (Modified Stochasticity Ratio, MST) have been deposited in Figshare and are publicly available [![DOI](https://zenodo.org/badge/DOI/10.6084/m9.figshare.32063493.svg)](https://doi.org/10.6084/m9.figshare.32063493). Due to the large file size (approximately 500 MB), the data could not be hosted on GitHub.
